...
<nav x-data="{ open: false }" class="bg-purple-900 border-b border-gray-100">
    ...
    <x-nav-link :href="route('produtos')" :active="request()->routeIs('produtos')" class="link" wire:navigate>
        Produtos
    </x-nav-link>

    <x-nav-link :href="route('vendas.create')" :active="request()->routeIs('vendas.create')" class="link" wire:navigate>
        Vendas
    </x-nav-link>

    <x-nav-link :href="route('pedidos.create')" :active="request()->routeIs('pedidos.create')" class="link" wire:navigate>
        Pedidos
    </x-nav-link>
</div>
